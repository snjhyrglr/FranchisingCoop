...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference("Municipality.count") do
      post municipalities_url, params: { municipality: { name: @municipality.name, province_id: @municipality.province_id, psgc_code: @municipality.psgc_code, region_id: @municipality.region_id } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { name: @municipality.name, province_id: @municipality.province_id, psgc_code: @municipality.psgc_code, region_id: @municipality.region_id } }
