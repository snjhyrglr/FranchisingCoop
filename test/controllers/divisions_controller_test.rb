...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: { division: { active: @division.active, name: @division.name, short_name: @division.short_name } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { active: @division.active, name: @division.name, short_name: @division.short_name } }
