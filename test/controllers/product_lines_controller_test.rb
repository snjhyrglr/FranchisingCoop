...
class ProductLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_line" do
    assert_difference("ProductLine.count") do
      post product_lines_url, params: { product_line: { active: @product_line.active, code: @product_line.code, name: @product_line.name } }
    end
  ...
  test "should update product_line" do
    patch product_line_url(@product_line), params: { product_line: { active: @product_line.active, code: @product_line.code, name: @product_line.name } }
